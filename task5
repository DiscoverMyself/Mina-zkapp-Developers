...
# Tutorial 5 - Common Types and Function
...
check verification hash, paste pubic key from private keys that you save before here: https://minascan.io/berkeley/account/

Fill out the [form](https://fisz9c4vvzj.typeform.com/zkSpark#discordid=xxxxx) (choose zkapp)
